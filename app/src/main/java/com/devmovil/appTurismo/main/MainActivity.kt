...
import com.devmovil.appTurismo.detalle.Detalle
...
class MainActivity : AppCompatActivity() {
   ...
   //Consumir datos del ServerMockup

   /*private val repository = LugaresRepository()
    fun getListaLugaresfromSever(){
        GlobalScope.launch(Dispatcher.ID){
            ListaLugares.value = repository.getLugares()
        }*/
    }
